...
class ProcessBatchFDAStateMachineFailedException(Exception): pass
...
def handler(event, context):
    ...
    email_subject = 'Job Failed : Process Batch FDA : ' + directory_name
    ...
    raise ProcessBatchFDAStateMachineFailedException('FDA process batch state machine failed to execute completely.')    